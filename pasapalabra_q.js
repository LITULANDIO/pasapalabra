...
var miarray = [{'id':'1', 'letra':'A', 'palabra':'silla', 'description': 'Mueble que se usa para sentarse...', 'check':null},{'id':'2', 'letra':'B', 'palabra':'alfabeto', 'description':'Grupo de letras...', 'check':null},
 ...
 $(document).ready(iniciar16);

function iniciar16(){

    $(".letraQ").click(ambar16);
    $(".letraQ").click(reloj16);
    $(".letraQ").click(Q); // inicio evento al clickar en el div A, al clikar se inicio la funcion A
...
}else if(segundos16>9){
document.getElementById('displayReloj').innerHTML = '00:' + segundos16;
}else{
document.getElementById('displayReloj').innerHTML = '00:' + '0' + segundos16;
     }
...
$(".letraQ").stop(ambar16);
$(".letraQ").css("background-color", "red");
$("#question").empty();
...
tiempo16 =  setTimeout(function(){reloj16()},1000);
}
segundos16--;
}
 ...
 $(".letraQ").fadeIn(400).delay(280).fadeOut(400, ambar16);
  ...
  $("#respuesta").empty();
  var description16 = "Contiene la letra Q: <br>"+miarray[16].description; 

   $("#question").append(description16);              //en el div question se añade la descripcion de la letra
   
    var boton16 = "<button type='button' id='boton'onclick='recibir16();'>Responder</button>";
    $("#form").append(boton16);
...
function recibir16(){                                    // se crea una función para agrupar las funcionalidades
        

var palabraQ= document.getElementById("palabra").value;     // se recoge el valor escrito en el input
var responde = document.getElementById("respuesta").innerHTML = palabraQ;  //en el div respuesta mostramos cuando nos interese el valor del input
 
 if (responde===miarray[16].palabra) {  // condicion: si el valor es igual a la palabra del array se eejecuta.....
  ...
  var color = $(".letraQ").css("background-color", "#3ADF00"); // el div cambiara su estado actual de color por un verde
...
var responde = document.getElementById("respuesta").innerHTML = "INCORRECTA<br> La palabra correcta es :"+ miarray[16].palabra; // se mostrara un mensaje
      
$(".letraQ").css("background-color", "red");  //el estado actual del div azul con la letra pasara a rojo
