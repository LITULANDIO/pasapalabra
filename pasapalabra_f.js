...
var miarray = [{'id':'1', 'letra':'A', 'palabra':'silla', 'description': 'Mueble que se usa para sentarse...', 'check':null},{'id':'2', 'letra':'B', 'palabra':'alfabeto', 'description':'Grupo de letras...', 'check':null},
 ...
 $(document).ready(iniciar5);

function iniciar5(){

    $(".letraF").click(ambar5);
    $(".letraF").click(reloj5);
    $(".letraF").click(F); // inicio evento al clickar en el div A, al clikar se inicio la funcion A
...
document.getElementById('displayReloj').innerHTML = '00:' + segundos5;
}else{
document.getElementById('displayReloj').innerHTML = '00:' + '0' + segundos5;
     }
...
$(".letraF").stop(ambar5);
$(".letraF").css("background-color", "red");
$("#question").empty();
...
tiempo5 =  setTimeout(function(){reloj5()},1000);
}
segundos5--;
}
 ...
 $(".letraF").fadeIn(400).delay(280).fadeOut(400, ambar5);
  ...
  $("#respuesta").empty();
  var description5 = "Contiene la letra F: <br>"+miarray[5].description; 

   $("#question").append(description5);              //en el div question se añade la descripcion de la letra
   
    var boton5 = "<button type='button' id='boton'onclick='recibir5();'>Responder</button>";
    $("#form").append(boton5);
...
function recibir5(){                                    // se crea una función para agrupar las funcionalidades
        

var palabraF= document.getElementById("palabra").value;     // se recoge el valor escrito en el input
var responde = document.getElementById("respuesta").innerHTML = palabraF;  //en el div respuesta mostramos cuando nos interese el valor del input
 
 if (responde===miarray[5].palabra) {  // condicion: si el valor es igual a la palabra del array se eejecuta.....
  ...
  var color = $(".letraF").css("background-color", "#3ADF00"); // el div cambiara su estado actual de color por un verde
...
var responde = document.getElementById("respuesta").innerHTML = "INCORRECTA<br> La palabra correcta es :"+ miarray[5].palabra; // se mostrara un mensaje
      
$(".letraF").css("background-color", "red");  //el estado actual del div azul con la letra pasara a rojo
