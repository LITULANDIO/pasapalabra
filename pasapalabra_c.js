...
function iniciar2(){
    ...
    $(".letracc").click(ambar2);
    $(".letracc").click(reloj2);
    $(".letracc").click(C); // inicio evento al clickar en el div A, al clikar se inicio la funcion A
...
document.getElementById('displayReloj').innerHTML = '00:' + segundos2;
}else{
document.getElementById('displayReloj').innerHTML = '00:' + '0' + segundos2;
     }
...
$(".letracc").stop(ambar2);
$(".letracc").css("background-color", "red");
$("#question").empty();
...
tiempo2 =  setTimeout(function(){reloj2()},1000);
}
segundos2--;
}
 ...
 $(".letracc").fadeIn(400).delay(280).fadeOut(400, ambar2);
  ...
  $("#respuesta").empty();
  var description2 = "Contiene la letra C: <br>"+miarray[2].description; 

   $("#question").append(description2);              //en el div question se añade la descripcion de la letra
   
    var boton2 = "<button type='button' id='boton'onclick='recibir2();'>Responder</button>";
    $("#form").append(boton2);
...
function recibir2(){                                    // se crea una función para agrupar las funcionalidades
        

var palabraC= document.getElementById("palabra").value;     // se recoge el valor escrito en el input
var responde = document.getElementById("respuesta").innerHTML = palabraC;  //en el div respuesta mostramos cuando nos interese el valor del input
 
 if (responde===miarray[2].palabra) {  // condicion: si el valor es igual a la palabra del array se eejecuta.....
  ...
  var color = $(".letracc").css("background-color", "#3ADF00"); // el div cambiara su estado actual de color por un verde
...
var responde = document.getElementById("respuesta").innerHTML = "INCORRECTA<br> La palabra correcta es :"+ miarray[2].palabra; // se mostrara un mensaje
      
$(".letracc").css("background-color", "red");  //el estado actual del div azul con la letra pasara a rojo
