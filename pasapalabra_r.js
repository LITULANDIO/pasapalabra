...
var miarray = [{'id':'1', 'letra':'A', 'palabra':'silla', 'description': 'Mueble que se usa para sentarse...', 'check':null},{'id':'2', 'letra':'B', 'palabra':'alfabeto', 'description':'Grupo de letras...', 'check':null},
 ...
 $(document).ready(iniciar17);

function iniciar17(){

    $(".letraR").click(ambar17);
    $(".letraR").click(reloj17);
    $(".letraR").click(R); // inicio evento al clickar en el div A, al clikar se inicio la funcion A
...
}else if(segundos17>9){
document.getElementById('displayReloj').innerHTML = '00:' + segundos17;
}else{
document.getElementById('displayReloj').innerHTML = '00:' + '0' + segundos17;
     }
...
$(".letraR").stop(ambar17);
$(".letraR").css("background-color", "red");
$("#question").empty();
...
tiempo17 =  setTimeout(function(){reloj17()},1000);
}
segundos17--;
}
 ...
 $(".letraR").fadeIn(400).delay(280).fadeOut(400, ambar17);
  ...
  $("#respuesta").empty();
  var description17 = "Contiene la letra R: <br>"+miarray[17].description; 

   $("#question").append(description17);              //en el div question se añade la descripcion de la letra
   
    var boton17 = "<button type='button' id='boton'onclick='recibir17();'>Responder</button>";
    $("#form").append(boton17);
...
function recibir17(){                                    // se crea una función para agrupar las funcionalidades
        

var palabraR= document.getElementById("palabra").value;     // se recoge el valor escrito en el input
var responde = document.getElementById("respuesta").innerHTML = palabraR;  //en el div respuesta mostramos cuando nos interese el valor del input
 
 if (responde===miarray[17].palabra) {  // condicion: si el valor es igual a la palabra del array se eejecuta.....
  ...
  var color = $(".letraR").css("background-color", "#3ADF00"); // el div cambiara su estado actual de color por un verde
...
var responde = document.getElementById("respuesta").innerHTML = "INCORRECTA<br> La palabra correcta es :"+ miarray[17].palabra; // se mostrara un mensaje
      
$(".letraR").css("background-color", "red");  //el estado actual del div azul con la letra pasara a rojo
