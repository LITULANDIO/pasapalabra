...
var miarray = [{'id':'1', 'letra':'A', 'palabra':'silla', 'description': 'Mueble que se usa para sentarse...', 'check':null},{'id':'2', 'letra':'B', 'palabra':'alfabeto', 'description':'Grupo de letras...', 'check':null},
 ...
 $(document).ready(iniciar6);

function iniciar6(){

    $(".letraG").click(ambar6);
    $(".letraG").click(reloj6);
    $(".letraG").click(G); // inicio evento al clickar en el div A, al clikar se inicio la funcion A
...
document.getElementById('displayReloj').innerHTML = '00:' + segundos6;
}else{
document.getElementById('displayReloj').innerHTML = '00:' + '0' + segundos6;
     }
...
$(".letraG").stop(ambar6);
$(".letraG").css("background-color", "red");
$("#question").empty();
...
tiempo6 =  setTimeout(function(){reloj6()},1000);
}
segundos6--;
}
 ...
 $(".letraG").fadeIn(400).delay(280).fadeOut(400, ambar6);
  ...
  $("#respuesta").empty();
  var description6 = "Contiene la letra G: <br>"+miarray[6].description; 

   $("#question").append(description6);              //en el div question se añade la descripcion de la letra
   
    var boton6 = "<button type='button' id='boton'onclick='recibir6();'>Responder</button>";
    $("#form").append(boton6);
...
function recibir6(){                                    // se crea una función para agrupar las funcionalidades
        

var palabraG= document.getElementById("palabra").value;     // se recoge el valor escrito en el input
var responde = document.getElementById("respuesta").innerHTML = palabraG;  //en el div respuesta mostramos cuando nos interese el valor del input
 
 if (responde===miarray[6].palabra) {  // condicion: si el valor es igual a la palabra del array se eejecuta.....
  ...
  var color = $(".letraG").css("background-color", "#3ADF00"); // el div cambiara su estado actual de color por un verde
...
var responde = document.getElementById("respuesta").innerHTML = "INCORRECTA<br> La palabra correcta es :"+ miarray[6].palabra; // se mostrara un mensaje
      
$(".letraG").css("background-color", "red");  //el estado actual del div azul con la letra pasara a rojo
