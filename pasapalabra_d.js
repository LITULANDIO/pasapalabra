...
var miarray = [{'id':'1', 'letra':'A', 'palabra':'silla', 'description': 'Mueble que se usa para sentarse...', 'check':null},{'id':'2', 'letra':'B', 'palabra':'alfabeto', 'description':'Grupo de letras...', 'check':null},
 ...
 $(document).ready(iniciar3);

function iniciar3(){

    $(".letraD").click(ambar3);
    $(".letraD").click(reloj3);
    $(".letraD").click(D); // inicio evento al clickar en el div A, al clikar se inicio la funcion A
...
document.getElementById('displayReloj').innerHTML = '00:' + segundos3;
}else{
document.getElementById('displayReloj').innerHTML = '00:' + '0' + segundos3;
     }
...
$(".letraD").stop(ambar3);
$(".letraD").css("background-color", "red");
$("#question").empty();
...
tiempo3 =  setTimeout(function(){reloj3()},1000);
}
segundos3--;
}
 ...
 $(".letraD").fadeIn(400).delay(280).fadeOut(400, ambar3);
  ...
  $("#respuesta").empty();
  var description3 = "Contiene la letra D: <br>"+miarray[3].description; 

   $("#question").append(description3);              //en el div question se añade la descripcion de la letra
   
    var boton3 = "<button type='button' id='boton'onclick='recibir3();'>Responder</button>";
    $("#form").append(boton3);
...
function recibir3(){                                    // se crea una función para agrupar las funcionalidades
        

var palabraD= document.getElementById("palabra").value;     // se recoge el valor escrito en el input
var responde = document.getElementById("respuesta").innerHTML = palabraD;  //en el div respuesta mostramos cuando nos interese el valor del input
 
 if (responde===miarray[3].palabra) {  // condicion: si el valor es igual a la palabra del array se eejecuta.....
  ...
  var color = $(".letraD").css("background-color", "#3ADF00"); // el div cambiara su estado actual de color por un verde
...
var responde = document.getElementById("respuesta").innerHTML = "INCORRECTA<br> La palabra correcta es :"+ miarray[3].palabra; // se mostrara un mensaje
      
$(".letraD").css("background-color", "red");  //el estado actual del div azul con la letra pasara a rojo
