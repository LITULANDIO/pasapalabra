...
var miarray = [{'id':'1', 'letra':'A', 'palabra':'silla', 'description': 'Mueble que se usa para sentarse...', 'check':null},{'id':'2', 'letra':'B', 'palabra':'alfabeto', 'description':'Grupo de letras...', 'check':null},
 ...
 $(document).ready(iniciar15);

function iniciar15(){

    $(".letraP").click(ambar15);
    $(".letraP").click(reloj15);
    $(".letraP").click(P); // inicio evento al clickar en el div A, al clikar se inicio la funcion A
...
}else if(segundos15>9){
document.getElementById('displayReloj').innerHTML = '00:' + segundos15;
}else{
document.getElementById('displayReloj').innerHTML = '00:' + '0' + segundos15;
     }
...
$(".letraP").stop(ambar15);
$(".letraP").css("background-color", "red");
$("#question").empty();
...
tiempo15 =  setTimeout(function(){reloj15()},1000);
}
segundos15--;
}
 ...
 $(".letraP").fadeIn(400).delay(280).fadeOut(400, ambar15);
  ...
  $("#respuesta").empty();
  var description15 = "Contiene la letra P: <br>"+miarray[15].description; 

   $("#question").append(description15);              //en el div question se añade la descripcion de la letra
   
    var boton15 = "<button type='button' id='boton'onclick='recibir15();'>Responder</button>";
    $("#form").append(boton15);
...
function recibir15(){                                    // se crea una función para agrupar las funcionalidades
        

var palabraP= document.getElementById("palabra").value;     // se recoge el valor escrito en el input
var responde = document.getElementById("respuesta").innerHTML = palabraP;  //en el div respuesta mostramos cuando nos interese el valor del input
 
 if (responde===miarray[15].palabra) {  // condicion: si el valor es igual a la palabra del array se eejecuta.....
  ...
  var color = $(".letraP").css("background-color", "#3ADF00"); // el div cambiara su estado actual de color por un verde
...
var responde = document.getElementById("respuesta").innerHTML = "INCORRECTA<br> La palabra correcta es :"+ miarray[15].palabra; // se mostrara un mensaje
      
$(".letraP").css("background-color", "red");  //el estado actual del div azul con la letra pasara a rojo
