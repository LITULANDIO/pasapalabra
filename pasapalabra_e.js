...
var miarray = [{'id':'1', 'letra':'A', 'palabra':'silla', 'description': 'Mueble que se usa para sentarse...', 'check':null},{'id':'2', 'letra':'B', 'palabra':'alfabeto', 'description':'Grupo de letras...', 'check':null},
 ...
 $(document).ready(iniciar4);

function iniciar4(){

    $(".letraE").click(ambar4);
    $(".letraE").click(reloj4);
    $(".letraE").click(E); // inicio evento al clickar en el div A, al clikar se inicio la funcion A
...
document.getElementById('displayReloj').innerHTML = '00:' + segundos4;
}else{
document.getElementById('displayReloj').innerHTML = '00:' + '0' + segundos4;
     }
...
$(".letraE").stop(ambar3);
$(".letraE").css("background-color", "red");
$("#question").empty();
...
tiempo4 =  setTimeout(function(){reloj4()},1000);
}
segundos4--;
}
 ...
 $(".letraE").fadeIn(400).delay(280).fadeOut(400, ambar4);
  ...
  $("#respuesta").empty();
  var description4 = "Contiene la letra E: <br>"+miarray[4].description; 

   $("#question").append(description4);              //en el div question se añade la descripcion de la letra
   
    var boton4 = "<button type='button' id='boton'onclick='recibir4();'>Responder</button>";
    $("#form").append(boton4);
...
function recibir4(){                                    // se crea una función para agrupar las funcionalidades
        

var palabraE= document.getElementById("palabra").value;     // se recoge el valor escrito en el input
var responde = document.getElementById("respuesta").innerHTML = palabraE;  //en el div respuesta mostramos cuando nos interese el valor del input
 
 if (responde===miarray[4].palabra) {  // condicion: si el valor es igual a la palabra del array se eejecuta.....
  ...
  var color = $(".letraE").css("background-color", "#3ADF00"); // el div cambiara su estado actual de color por un verde
...
var responde = document.getElementById("respuesta").innerHTML = "INCORRECTA<br> La palabra correcta es :"+ miarray[4].palabra; // se mostrara un mensaje
      
$(".letraE").css("background-color", "red");  //el estado actual del div azul con la letra pasara a rojo
